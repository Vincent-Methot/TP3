...
La fonction \lstinline{Q2_IRMd.compAdcAndFa} calcule l'ADC et la FA à partir d'un champ de tenseur tel que calculé par la fonction \lstinline{Q2_IRMd.tenseur}. Les fig. \ref{adc_fiber} et \ref{fa_fiber} illustrent pour certaines tranches l'ADC et la FA, respectivement. Les unités de l'ADC sont les mêmes que celles du coefficients de diffusion, soit $[longueur]^2/[temps]$, et la FA est sans unité.

\begin{figure}
\begin{center}
\includegraphics[scale=0.22]{adc_fiber}
\caption{ADC visualisée dans le Fibernavigator. \label{adc_fiber}}
\end{center}
\end{figure}

\begin{figure}
\begin{center}
\includegraphics[scale=0.22]{fa_fiber}
\caption{FA visualisée dans le Fibernavigator. \label{fa_fiber}}
\end{center}
\end{figure}
